    ...
    if (currentStep === steps.length - 1) {
      ...
      try {
        const response = await api.post('/api/v1/families', {
          ...
          patientDateOfBirth: dateInputToLocalISOString(formData.patientDateOfBirth),
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary-50 to-white dark:from-slate-900 dark:to-slate-800 flex items-center justify-center p-4">
      <div className="w-full max-w-2xl">
        {/* Progress bar */}
        <div className="mb-8">
          <div className="flex flex-wrap items-center justify-center gap-3 sm:justify-between mb-2">
            {steps.map((step, index) => (
              ...
              >
                <div className={cn(
                  ...
                  index === currentStep && 'bg-primary-600 text-white ring-4 ring-primary-200 dark:ring-primary-800',
                  index > currentStep && 'bg-gray-200 text-gray-500 dark:bg-slate-700 dark:text-gray-400'
                )}>
                  {index < currentStep ? (
                ...
                {index < steps.length - 1 && (
                  <div className={cn(
                    ...
                    index < currentStep ? 'bg-primary-600' : 'bg-gray-200 dark:bg-slate-700'
                  )} />
                )}
              </div>
            ))}
        ...
        {/* Card */}
        <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-xl dark:shadow-slate-900/50 p-6 sm:p-8">
          {/* Step header */}
          <div className="text-center mb-8">
            <div className="w-16 h-16 sm:w-20 sm:h-20 bg-primary-100 dark:bg-primary-900/30 rounded-2xl flex items-center justify-center mx-auto mb-4">
              <CurrentIcon className="h-10 w-10 text-primary-600 dark:text-primary-400" />
            </div>
          ...
          <div className="space-y-6">
            {currentStep === 0 && (
              <div className="text-center space-y-4">
                ...
                <div className="bg-primary-50 dark:bg-primary-900/30 rounded-xl p-6 text-left">
                  <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-3">What you'll be able to do:</h3>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 border-2 border-gray-200 dark:border-slate-600 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-colors bg-white dark:bg-slate-700 dark:text-gray-100"
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between mt-8">
            <button
              ...
              className={cn(
                'flex w-full sm:w-auto items-center justify-center gap-2 px-6 py-3 rounded-xl font-medium transition-all',
                currentStep === 0
